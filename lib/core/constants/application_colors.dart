...
class ApplicationColors {
  ...
  static const Color blueGreyTransparent = Color(0x80607D8B);
  ...
  static const Color deepOrangeTransparent = Color(0x80FF5722);
  static const Color deepPurpleTransparent = Color(0x80673AB7);
  ...
  static const Color lightBlueTransparent = Color(0x8003A9F4);
  static const Color lightGreenTransparent = Color(0x808BC34A);
  ...
  static const List<Color> transparentColors = [
    amberTransparent,
    blueTransparent,
    blueGreyTransparent,
    brownTransparent,
    cyanTransparent,
    deepOrangeTransparent,
    deepPurpleTransparent,
    greenTransparent,
    greyTransparent,
    indigoTransparent,
